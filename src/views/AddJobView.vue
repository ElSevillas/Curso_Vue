                ...
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" v-model="form.title" 
                            id="name" name="name" class="border rounded w-full py-2 px-3 mb-2" placeholder="eg. Beautiful Apartment In Miami" required />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" v-model="form.description"
                            name="description" class="border rounded w-full py-2 px-3" rows="4"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" v-model="form.location" 
                            id="location" name="location" class="border rounded w-full py-2 px-3 mb-2"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" v-model="form.company.name" 
                            id="company" name="company" class="border rounded w-full py-2 px-3"
                    ...
                    <div class="mb-4">
                        ...
                        <label for="company_description" class="block text-gray-700 font-bold mb-2">Company
                            Description</label>
                        <textarea id="company_description" v-model="form.company.description" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" v-model="form.company.contactEmail" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="tel" v-model="form.company.contactPhone" 
